...
def generate_launch_description():
    ...
    # taking example from here https://github.com/moveit/moveit2/blob/main/moveit_ros/moveit_servo/launch/demo_ros_api.launch.py
    servo_params = {
    ...
    dino_controller_node = Node(
        package="dino_kg",
        executable="dino_controller",
        name="dino_controller",
        output="screen",
        parameters=[{
            "use_sim_time": LaunchConfiguration("use_sim_time"),
            }],
